...
from voltron.kernels import BMKernel, VolatilityKernel, FBMKernel, BM2Kernel, BM3Kernel
...
def TrainVolModel(train_x, vol_path, train_iters=1000, printing=False, kernel = "bm2"):
